...
class PlexRepository(private val context: Context) {
    ...
    suspend fun savePreferredPlayer(player: String) {
        context.dataStore.edit {
            it[preferredPlayerKey] = if (player == "vlc") "vlc" else "exo"
        }
    }
